...
const MNIST_IMAGES_SPRITE_PATH =
    './data/mnist/mnist_images.png';
const MNIST_LABELS_PATH =
    './data/mnist/mnist_labels_uint8';
...
export class MnistData {
     ...
     * @memberof MnistData
     */
    public shuffledTrainIndex: number = 0;
    /**
     *
     *
     * @type {number}
     * @memberof MnistData
     */
    public shuffledTestIndex: number = 0;
    /**
     *
     *
     * @type {*}
    ...
    public async load() {
        ...
        const [imgResponse, labelsResponse]: any = await Promise.all([imgRequest, labelsRequest]);
